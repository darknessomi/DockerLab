...
class UserController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
                ...
                'ips'=> Yii::app()->params['ips'],
				'expression'=>'isset(Yii::app()->user->title) && Role::TYPE_SYSTEM_ADMIN == Yii::app()->user->title',
			),
	...
	public function actionCreate()
	{
        ...
        if($_POST && $_POST['User']) {
            $_POST['User']['salt'] = $this->_get_salt(6);
            $_POST['User']['delete_flag'] = 0;
    ...
    private function _get_salt($length = 0) {
        $result = '';
        for($i = 0; $i < $length; $i++) {
